export const restaurantMenus = [
    ...
    [

        {
            name: "Pizza",
            foods: [
                ["Margherita Pizza", "Classic pizza with tomato sauce, mozzarella and basil", 180000],
                ["Pepperoni Pizza", "Pizza with pepperoni and mozzarella cheese", 230000],
                ["Special Pizza", "Pizza with beef, mushrooms, peppers and special sauce", 260000],
                ...
                ["Beef Mushroom Pizza", "Pizza with beef, mushrooms and mozzarella cheese", 240000],
                ["BBQ Chicken Pizza", "Pizza with grilled chicken and BBQ sauce", 240000],
                ["Four Cheese Pizza", "Pizza with four types of cheese", 270000],
                ["Spicy Beef Pizza", "Spicy pizza with beef, jalapeno and cheese", 250000],
                ["Meat Lovers Pizza", "Pizza with beef, pepperoni, sausage and mozzarella", 280000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Bacon Burger", "Beef burger with crispy beef bacon and cheese", 240000],
                ["Jalapeno Burger", "Spicy beef burger with jalapeno and cheese", 225000],
                ["Smoky Burger", "Beef burger with smoked sauce and cheese", 230000],
                ["Triple Burger", "Triple beef burger with cheese and special sauce", 290000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Khoresh Bademjan", "Eggplant stew with tomato and meat", 220000],
                ["Khoresht Karafs", "Celery stew with herbs and meat", 225000],
                ["Khoresht Gheimeh Bademjan", "Split pea and eggplant stew with rice", 225000],
                ["Khoresht Alu", "Iranian prune stew with meat", 230000],
                ["Khoresht Beh", "Quince stew with meat and saffron", 235000],
                ["Khoresht Loobia", "Iranian kidney bean stew with meat and rice", 215000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Adas Polo", "Lentil rice with raisins and meat", 230000],
                ["Shirin Polo", "Sweet Persian rice with chicken", 260000],
                ["Tahchin", "Persian crispy saffron rice with chicken", 250000],
                ["Loobia Polo", "Rice with green beans, tomato and meat", 240000],
                ["Estanboli Polo", "Persian tomato rice with potatoes and meat", 230000],
                ["Morasa Polo", "Persian rice with nuts, orange peel and chicken", 290000],
                ["Kalam Polo", "Persian rice with cabbage and meatballs", 250000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Sultani Kebab", "Combination of barg and koobideh kebab", 340000],
                ["Chenjeh Kebab", "Grilled marinated beef cubes", 310000],
                ["Kebab Torsh", "Northern Iranian style sour marinated kebab", 320000],
                ["Kebab Soltani Joojeh", "Chicken and koobideh combination", 310000],
                ["Kebab Barg Special", "Premium beef fillet kebab with saffron rice", 350000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Double Burger", "Double beef burger with cheese", 250000],
                ["BBQ Burger", "Beef burger with BBQ sauce", 230000],
                ["Spicy Burger", "Spicy beef burger with jalapeno", 220000],
                ["Bacon Burger", "Beef burger with crispy beef bacon", 240000],
                ["Smoky Burger", "Beef burger with smoked sauce and cheese", 230000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Chicken Wings", "Crispy chicken wings", 150000],
                ["Popcorn Chicken", "Small crispy chicken pieces", 145000],
                ["Spicy Fried Chicken", "Spicy crispy fried chicken", 180000],
                ["Chicken Tenders", "Golden fried chicken tenders", 165000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Club Sandwich", "Three-layer sandwich with chicken and vegetables", 210000],
                ...
                ["Spicy Chicken Sandwich", "Spicy chicken sandwich with special sauce", 185000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Khoresht Karafs", "Celery stew with herbs and meat", 225000],
                ["Khoresht Alu", "Prune stew with meat", 230000],
                ["Khoresht Beh", "Quince stew with meat", 235000],
                ["Khoresht Loobia", "Kidney bean stew with meat", 215000],
                ["Khoresht Bamieh", "Okra stew with tomato and meat", 220000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Barg Kebab", "Grilled beef fillet kebab", 320000],
                ["Bakhtiari Kebab", "Mixed beef and chicken kebab", 300000],
                ["Sultani Kebab", "Combination of barg and koobideh", 340000],
                ["Chenjeh Kebab", "Grilled marinated beef cubes", 310000],
                ["Kebab Torsh", "Northern Iranian style sour kebab", 320000],
                ["Joojeh Special", "Special grilled chicken kebab with saffron", 280000],
                ["Kebab Soltani", "Premium combination kebab with saffron rice", 350000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Loobia Polo", "Rice with green beans and meat", 240000],
                ["Estanboli Polo", "Persian tomato rice with meat", 230000],
                ["Morasa Polo", "Persian rice with nuts and chicken", 290000],
                ["Kalam Polo", "Persian rice with cabbage and meatballs", 250000],
                ["Sabzi Polo Mahi", "Persian herb rice with fish", 280000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Persian Pepperoni Pizza", "Iranian style pizza with pepperoni and cheese", 250000],
                ["Mushroom Pizza", "Pizza with mushrooms and mozzarella", 210000],
                ["Beef Sausage Pizza", "Pizza with beef sausage and cheese", 245000],
                ["Spicy Meat Pizza", "Spicy Iranian style meat pizza", 260000],
                ["Mixed Sausage Pizza", "Pizza with mixed sausages, mushrooms and cheese", 255000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Margherita Pizza", "Classic tomato and mozzarella pizza", 190000],
                ["Buffalo Chicken Pizza", "Pizza with buffalo chicken and cheese", 260000],
                ["Supreme Pizza", "Pizza with meat, mushrooms, peppers and olives", 280000],
                ["Cheese Lovers Pizza", "Pizza with extra mozzarella and cheddar", 250000],
                ["Spicy Pepperoni Pizza", "Spicy pepperoni pizza with jalapeno", 260000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Penne Pesto", "Penne pasta with basil pesto sauce", 220000],
                ["Fettuccine Alfredo", "Fettuccine with creamy Alfredo sauce", 235000],
                ["Spaghetti Pomodoro", "Spaghetti with fresh tomato sauce", 200000],
                ["Chicken Pesto Pasta", "Pasta with grilled chicken and pesto sauce", 245000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Eggplant Parmesan", "Baked eggplant with tomato sauce and parmesan", 220000],
                ["Mushroom Risotto", "Creamy risotto with mushrooms", 240000],
                ["Chicken Milanese", "Breaded chicken with Italian herbs", 250000],
                ["Gnocchi Alfredo", "Potato gnocchi with creamy Alfredo sauce", 230000],
                ["Gnocchi Pomodoro", "Potato gnocchi with tomato sauce", 215000],
                ["Cannelloni", "Italian pasta rolls filled with meat and cheese", 260000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Popcorn Chicken", "Small crispy chicken pieces", 145000],
                ["Chicken Tenders", "Golden fried chicken tenders", 165000],
                ["Crispy Chicken Breast", "Crispy fried chicken breast", 185000],
                ["Hot Chicken", "Extra spicy crispy chicken", 195000],
                ["Chicken Drumsticks", "Crispy fried chicken drumsticks", 175000],
                ["Chicken Fillet", "Breaded crispy chicken fillet", 180000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Two Piece Chicken Meal", "Two pieces of chicken with fries", 230000],
                ["Three Piece Chicken Meal", "Three pieces of chicken with fries", 290000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Mushroom Chicken Burger", "Chicken burger with mushrooms and cheese", 215000],
                ["Crispy Deluxe Burger", "Crispy chicken burger with special sauce", 225000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["Roast Beef Sandwich", "Roast beef sandwich with cheese", 210000],
                ["Turkey Sandwich", "Turkey sandwich with lettuce and cheese", 180000],
                ["Chicken Caesar Sandwich", "Chicken sandwich with Caesar dressing", 190000],
                ["Philly Beef Sandwich", "Sliced beef sandwich with cheese and vegetables", 220000],
                ["Grilled Vegetable Sandwich", "Grilled vegetables with cheese in fresh bread", 150000],
                ["Crispy Chicken Sandwich", "Crispy chicken sandwich with special sauce", 185000]
            ]
        },

        {
            ...
            foods: [
                ...
                ["Sausage Sandwich", "Sausage sandwich with special sauce", 170000],
                ["Mushroom Sandwich", "Mushroom sandwich with cheese", 180000],
                ["Hot Beef Sandwich", "Hot beef sandwich with melted cheese", 210000],
                ["Grilled Chicken Sandwich", "Grilled chicken with vegetables and sauce", 180000],
                ["Spicy Sausage Sandwich", "Spicy sausage sandwich with cheese", 185000],
                ["Roast Beef Melt", "Roast beef with melted cheese", 220000],
                ["Chicken Mushroom Melt", "Chicken, mushrooms and melted cheese", 200000]
            ]
        },
...

        {
            ...
            foods: [
                ...
                ["Garden Salad", "Fresh mixed vegetable salad", 110000],
                ["Coleslaw", "Fresh creamy coleslaw", 85000],
                ["Greek Salad", "Fresh Greek salad with feta cheese", 140000]
            ]
        },
    ...
    [

        {
            ...
            foods: [
                ...
                ["BBQ Fries", "French fries with BBQ sauce and cheese", 115000],
                ["Loaded Beef Fries", "Fries topped with beef, cheese and sauce", 170000]
            ]
        },
